...
class JourneyButton: UIButton {
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        tintColor = UIColor.init(contrastingBlackOrWhiteColorOn: UIColor.flatRedDark, isFlat: true)
        
        titleLabel?.font = Utilities.getFont(.calibreBold, size: 18.0)
